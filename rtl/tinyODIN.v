...
module tinyODIN #(
    ...
    // Configuration    -------------------------------
    input  wire           CFG_GATE_ACTIVITY,
    input  wire           CFG_OPEN_LOOP,
    input  wire           CFG_AER_SRC_CTRL_nNEUR,
    input  wire   [M-1:0] CFG_MAX_NEUR,
    ...
    aer_out #(
        ...
        .SPI_GATE_ACTIVITY_sync(CFG_GATE_ACTIVITY_sync),
        .SPI_AER_SRC_CTRL_nNEUR(CFG_AER_SRC_CTRL_nNEUR),
    ...
    controller #(
        ...
        .SPI_GATE_ACTIVITY(CFG_GATE_ACTIVITY),
        .SPI_GATE_ACTIVITY_sync(CFG_GATE_ACTIVITY_sync),
        .SPI_MAX_NEUR(CFG_MAX_NEUR),
